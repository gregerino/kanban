...
function createSampleBoard() {
  ...
  const tasks = [
    { id: uid(), storyId: stories[0].id, title: 'Design login page', status: 'Done', priority: 'High', labels: [labels[0].id, labels[4].id], deadline: '2026-05-15', color: '#fde68a', comments: [{ id: uid(), author: 'Me', text: 'Looks great! Approved.', date: '2026-05-14T10:30:00' }], checklist: [], notes: '', files: [] },
    { id: uid(), storyId: stories[0].id, title: 'Implement auth API', status: 'In Progress', priority: 'Critical', labels: [labels[1].id], deadline: '2026-05-20', color: '#fde68a', comments: [], checklist: [{ id: uid(), text: 'Set up JWT tokens', done: true }, { id: uid(), text: 'Create login endpoint', done: false }, { id: uid(), text: 'Create register endpoint', done: false }], notes: '', files: [] },
    { id: uid(), storyId: stories[0].id, title: 'Add password reset flow', status: 'To Do', priority: 'Medium', labels: [labels[0].id, labels[1].id], deadline: '2026-05-25', color: '#fde68a', comments: [], checklist: [], notes: '', files: [] },
    { id: uid(), storyId: stories[0].id, title: 'Write auth tests', status: 'Backlog', priority: 'Low', labels: [labels[1].id], deadline: '', color: '#fde68a', comments: [], checklist: [], notes: '', files: [] },
    { id: uid(), storyId: stories[1].id, title: 'Create chart components', status: 'In Progress', priority: 'High', labels: [labels[0].id, labels[3].id], deadline: '2026-05-22', color: '#fde68a', comments: [{ id: uid(), author: 'Me', text: 'Use recharts library for this.', date: '2026-05-18T09:00:00' }], checklist: [], notes: '', files: [] },
    { id: uid(), storyId: stories[1].id, title: 'Responsive layout', status: 'To Do', priority: 'Medium', labels: [labels[0].id, labels[4].id], deadline: '2026-05-28', color: '#fde68a', comments: [], checklist: [], notes: '', files: [] },
    { id: uid(), storyId: stories[1].id, title: 'Fix sidebar navigation bug', status: 'Review', priority: 'High', labels: [labels[0].id, labels[2].id], deadline: '2026-05-19', color: '#fde68a', comments: [], checklist: [], notes: '', files: [] },
    { id: uid(), storyId: stories[2].id, title: 'Stripe payment integration', status: 'Backlog', priority: 'Critical', labels: [labels[1].id, labels[3].id], deadline: '2026-06-01', color: '#fde68a', comments: [], checklist: [], notes: '', files: [] },
    { id: uid(), storyId: stories[2].id, title: 'Email notification service', status: 'To Do', priority: 'Medium', labels: [labels[1].id], deadline: '2026-06-05', color: '#fde68a', comments: [], checklist: [], notes: '', files: [] },
    { id: uid(), storyId: stories[2].id, title: 'Webhook endpoints', status: 'Backlog', priority: 'Low', labels: [labels[1].id], deadline: '', color: '#fde68a', comments: [], checklist: [], notes: '', files: [] },
  ];
