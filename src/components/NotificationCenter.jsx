        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 z-40 bg-white rounded-xl shadow-xl border border-gray-100 w-80 max-h-96 overflow-hidden flex flex-col">
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
              ...
              {allNotifs.length > 0 && (
                <button onClick={dismissAll} className="text-xs text-indigo-500 hover:text-indigo-700 font-medium">Mark all read</button>
              )}
            </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 mt-0.5">
                        {n.type === 'overdue'
                          ? `Overdue since ${n.deadline}`
                          : n.hoursLeft <= 0
                            ? 'Due today!'
                            : `Due in ${n.hoursLeft}h — ${n.deadline}`
                        }
                      </p>
                    </div>
